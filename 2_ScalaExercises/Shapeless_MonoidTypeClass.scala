/**
* when the general deriving infrastructure for monoids is in place,
* instances are automatically available for arbitrary case classes
...
val fooCombined = Foo(13, "foo") |+| Foo(23, "bar") // return Foo(36, "foobar")
val barCombined = Bar(true, "foo", 1.0) |+| Bar(false, "bar", 3.0) // return Bar(true, "foobar", 4.0)
